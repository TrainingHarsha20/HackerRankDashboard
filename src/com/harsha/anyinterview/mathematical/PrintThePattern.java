...
import com.harsha.coderbyte.ShortestPath;
...
public class PrintThePattern {
    ...
    static void repeatNumOfTimes(int repeat, int val, StringBuilder sb){
        while(repeat > 0){
    ...
    public static void main (String[] args) {
        ...
        System.out.print(printPattern(s.nextInt()));
    }
}
